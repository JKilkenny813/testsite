...
3.	How might the role of a system administrator change in an organization that made use of dapps?
  ...
  Here’s a document that covers different roles within dApps   <p><a href="https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.84.8160&rep=rep1&type=pdf">Decentralized User-Role Assignment
for Web-based Intranets </a></p>.
...
Dealing with browser plugins, extensions or entirely new and unfamiliar crypto-enabled browsers, along with the
  ...
  Here’s a link to a blog that discusses how they utilize four different ways of managing user accounts based on need. 
   <p><a href="https://blog.wetrust.io/designing-user-account-systems-in-ethereum-apps-f824fe625412">Designing user account systems in Ethereum apps</a></p>.

...
const SecondPage = () => (
  ...
  First off what is a dApp? A dApp is a decentralized application. </p>
  
<p>What are the biggest practical barriers to dApps adoption?</p>
  
  <p>One of the biggest barriers to dApps adoption is lack of knowledge or understanding around how easy and secure these applications are to create and deploy. For example, 
  ...
  <a href="https://hackernoon.com/decentralised-applications-and-the-problem-with-adoption-9cfdaa868b2b">string</a></p>
  
<p>	What are the security advantages and disadvantages of dapps?</p>
<p>Here are some of the advantages of utilizing a dApp; Simple to develop, more control, safe data, open source, transparent data, less downtime, data is never lost, can’t be blocked, cost reduction.
 ...
 in order to cause a point of failure in the system. The negative to this is that traditional security solutions dont work and a dApp specific solution needs to be implemented. Valid Networks’ blockchain security platform for dApps does just that.
   ...
   <a href=" https://valid.network/post/decentralized-applications-the-good-the-bad-and-why-should-enterprises-care>string"</a>
  </p>
  
	<p>How might the role of a system administrator change in an organization that made use of dapps?</p> 
  
<p>  Some of the system administrator tasks may be off loaded by being automated so the role itself may become more diversified and look more like a system engineer. 
  ...
  Here’s a document that covers different roles within dApps    <a href="https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.84.8160&rep=rep1&type=pdf">string</a> </p>

  
  
<p>	Is it possible to manage dApps for a team of users like we might with traditional SaaS business applications? 
  If so, how might it be done? If not, what are the implications for organizational dapp use?</p>
  <p>
Dealing with browser plugins, extensions or entirely new and unfamiliar crypto-enabled browsers, along with the
 ...
 <a href="https://blog.wetrust.io/designing-user-account-systems-in-ethereum-apps-f824fe625412">string</a> </p>
